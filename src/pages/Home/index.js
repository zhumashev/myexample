...
import allReducers from '../../myversion/reducers'
import {Provider} from 'react-redux';
import ListIns from '../../myversion/components/ListIns';
      ...
      <div className="d-flex flex-column" style={{height: '100vh', minHeight: '1000px'}}>
        ...
        <div style={{height: '66.666%', width: '100%'}} className="d-flex flex-row justify-content-around">
          ...
          <Provider store={store}>
            <Card title={"Insurance body"} component={<ListIns/>} style={{height: 'calc(50% - 30px)'}} />
          </Provider>
